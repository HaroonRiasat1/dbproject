...
<h1>Please enter details of Nutrition Plans </h1>
	  <form method="post" action="" name="myForm" onsubmit="return validateForm()">
			  <div class="form-row">
				  <div class ="col-lg-7">
				  
				  <input type="text" placeholder="DAY"   name="day" class="form-control my-3 p-4">
				  ...
				  <input type="text" placeholder="Name" name="Nname" class="form-control my-3 p-4">
				  ...
				  <input type="text" placeholder="Nutrition Description" name="ndep" class="form-control my-3 p-4">
				  ...
				  <input type="number" placeholder="Allowed Intake cl" name="intake" class="form-control my-3 p-4">
				  ...
				  <input type="number" placeholder="Allowance" name="allo" class="form-control my-3 p-4">
...
$days=$_POST["days"];
$name=$_POST["Nname"];
$Description=$_POST["ndep"];
$Allowance=$_POST["allo"];
$DAY=$_POST["day"];
$in=$_POST["intake"];
...
$q="insert into proj_nutrition values(nut.nextval,'$name','$Description','$Allowance','$Allowance','$DAY')";
$query_id = oci_parse($con, $q); 		
$r = oci_execute($query_id);


$q="select NUTRITION_ID from proj_nutrition order by NUTRITION_ID";
	$query_id = oci_parse($con, $q); 		
$r = oci_execute($query_id);
 while($row = oci_fetch_array($query_id, OCI_BOTH+OCI_RETURN_NULLS)) 
      	  {
...
$q="insert into PROJ_REQUIRES VALUES('$Pid',PR.nextval,'$nid','')";
$query_id = oci_parse($con, $q); 		
$r = oci_execute($query_id);
