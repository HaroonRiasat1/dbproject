...
<h1>Press Enter to check Search Excercise Or Nutrition Plan</h1>
	  <form method="post" action="" name="myForm" onsubmit="return validateForm()">
			  ...
			  <div class="form-row">
				  <div class ="col-lg-7">
				   ...
				   <input class ="col-lg-0" type="radio" name="sel" value="Excercise">Excercise <br>  
					<input  class ="col-lg-0"type="radio" name="sel" value="Nutrition">Nutrition <br>  
				  ...
				  <input type="text" placeholder=" Name"   name="NAME" class="form-control my-3 p-4">
				    ...
				    <div class="form-row">
				  <div class ="col-lg-7">
					  <input type="submit" name="submit12" class="btn1 mt-3 mb-5" value="Search"/>
...
{
  $ED= $row["EXERCISE_ID"];
		$q="SELECT * from PROJ_EXERCISE where NAME='$NAME'";
...
<th>DAY</th>
	...
	$q="SELECT * from PROJ_NUTRITION where NAME='$NAME'";
		$query_id1 = oci_parse($con, $q); 		
		$r = oci_execute($query_id1);
